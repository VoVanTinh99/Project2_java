	...
	if(isset($result))
	{
		list($CategoryId,$name,$description)=mysqli_fetch_array($result);
	}
	...
	<div class="row">
		...
		<form action="" method="post" accept-charset="utf-8" enctype="multipart/form-data" form-horizontal>
			<div class="form_group">
				<label class="control-label col-sm-12" for="email"><h2 align="center">Category</h2></label>
			</div>
		...
		<form class="form-horizontal" accept-charset="utf-8" method="post" role="form" >
			...
			<div class="form-group">
				<label class="control-label col-md-2" for="txtName">Category Name:</label>
				<div class="col-sm-10">
